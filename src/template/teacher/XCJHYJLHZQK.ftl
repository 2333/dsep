	<table class="textCenter">
		...
		<tbody>
			...
			<tr class="simSun wuHao">
				...
				<td width="3.00cm">${XCJHYJLHZQKData.HYMC}</td>
				<td width="6.00cm">${XCJHYJLHZQKData.HYBGMC}</td>
				<td width="2.50cm">${XCJHYJLHZQKData.CJSJ}</td>
				<td width="2.50cm">${XCJHYJLHZQKData.RJSJ}</td>
				<td width="3.00cm">${XCJHYJLHZQKData.HYDD}</td>
				<td width="2.80cm">${XCJHYJLHZQKData.ZBDW}</td>
				<td width="2.50cm">${XCJHYJLHZQKData.BGXS}</td>
			</tr>
			</#list>
			<!--freemarker end-->			
		</tbody>
