	<table class="textCenter">
		...
		<tbody>
			...
			<tr class="simSun wuHao">
				...
				<td width="4.75cm">${ZJKCQKData.KCMC}</td>
				<td width="2.57cm">${ZJKCQKData.SKJS}</td>
				<td width="2.28cm">${ZJKCQKData.KCLX}</td>
				<td width="2.00cm">${ZJKCQKData.KKNF}</td>
				<td width="1.50cm">${ZJKCQKData.XQ}</td>
				<td width="2.00cm">${ZJKCQKData.XSRS}</td>
				<td width="2.00cm">${ZJKCQKData.XSS}</td>
				<td width="2.00cm">${ZJKCQKData.XF}</td>
				<td width="2.50cm">${ZJKCQKData.SZXY}</td>
				<td width="1.84cm">${ZJKCQKData.SKDX}</td>
			</tr>
			</#list>
			<!--freemarker end-->			
		</tbody>
