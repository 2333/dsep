	<table class="textCenter">
		...
		<tbody>
			...
			<tr class="simSun wuHao">
				...
				<td width="6.57cm">${XJPKFKCData.KCMC}</td>
				<td width="4.57cm">${XJPKFKCData.KCLB}</td>
				<td width="4.07cm">${XJPKFKCData.PZND}</td>
				<td width="4.57cm">${XJPKFKCData.JSDW}</td>
				<td width="3.07cm">${XJPKFKCData.KCFZRXM}</td>
			</tr>
			</#list>
			<!--freemarker end-->			
		</tbody>
