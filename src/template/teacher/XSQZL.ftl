	<table class="textCenter">
		...
		<tbody>
			...
			<tr class="simSun wuHao">
				...
				<td width="5.50cm">${XSQZLData.ZLMC}</td>
				<td width="3.50cm">${XSQZLData.ZLH}</td>
				<td width="2.72cm">${XSQZLData.ZLSQGJ}</td>
				<td width="2.42cm">${XSQZLData.ZLLX}</td>
				<td width="1.22cm">${XSQZLData.ZLSQNY}</td>
				<td width="2.42cm">${XSQZLData.ZLQRXM}</td>
				<td width="2.42cm">${XSQZLData.DYFMR}</td>
				<td width="2.59cm">${XSQZLData.ZLZR}</td>
				<td width="2.29cm">${XSQZLData.ZLYYQKSM}</td>
			</tr>
			</#list>
			<!--freemarker end-->			
		</tbody>
