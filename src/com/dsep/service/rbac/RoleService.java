...
public interface RoleService {
	...
	public abstract Set<Role> getUserRoles(Integer userId);
	
	/** 取得某用户的角色键值对
	 * @param userId
	 * @return Map<Role,该User是否有该角色（没有0，有1）>
	 */
	public abstract List<CheckTreeVM> getroleTreeVMs(Integer userId);
	public abstract List<CheckTreeVM> getUserRolesTree(Integer userId);
