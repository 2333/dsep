...
@Controller
@RequestMapping("PublicDataManage/viewData/import")
public class PublicImportController {
							...
							HttpServletResponse response)
	{
		try{
			...
			return importService.importExcelByEntityId(entityId, "G",importFile, rootPath, null, null);}
		catch (Exception e) {
	...
	{
		String rootPath = request.getSession().getServletContext().getRealPath("/");
 		String excelName = importService.createExcelTmpByEntityId(entityId,"G", rootPath, null);
		return excelName;
	}
