...
@Controller
@RequestMapping("Collect/toCollect/export")
public class CollectExportController {
	@Resource(name="exportService")
	private ExportService exportService;
	
	@RequestMapping(value = "/excel/{unitId}/{discId}/{tableId}/{sortOrder}/{sortName}",method=RequestMethod.POST)
	@ResponseBody
	public String exportExcel(@PathVariable(value="unitId")String unitId,
							  ...
							  HttpServletResponse response)
	{
		...
		String fileString = exportService.exportExcelByEntityId(unitId, discId, entityId, "C",asc, orderPropName, rootPath,searchGroup);
		return fileString;
	}
