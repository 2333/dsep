...
public class PrePublicityManagementVM {
	...
	public PrePublicityManagementVM(){
		
	}
	
	public PrePublicityManagementVM(PublicityManagement management){
	...
	public void setActualEndTime(Date actualEndTime) {
		this.actualEndTime = DateProcess.getShowingFormatDate(actualEndTime);
	}
