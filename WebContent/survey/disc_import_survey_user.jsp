...
<script type="text/javascript">
	...
	$(function(){ 
		...
		$("#download").click(function() {
			var url = "${ContextPath}/InfoMaintain/discQNRInfo_download/E082B40F1E30401B9501566DEDC2FC86";
		...
		$("#file_upload").uploadify({  
            ...
            'uploader'       : '${ContextPath}/InfoMaintain/discQNRInfo_upload?jsessionid=' + $("#sessionid").val(),//后台处理的请求    
            'queueID'        : 'fileQueue',
            'queueSizeLimit' : 1,  
            'auto'           : false,
            'buttonText'     : '附件',
	 	...
	 	$('#delete').click(function(){
	 		$.post('${ContextPath}/InfoMaintain/discQNRInfo_deleteFile',{id:$("#file_no").text()} ,function(data){
	 			if(data){
	 				alert_dialog("附件已删除！");
	 				$("#file_detail").text("");
	 				$("#file_no").text("");
