...
<div class="con_header">
	...
	<a id="save_paper" class="button right" href="#">
		<span class="icon icon-export"></span>保存问卷
	</a>
	<a id="pre_see" class="button right" href="#" onclick="preview()">
		<span class="icon icon-download"></span>预览问卷
	</a>
	<a id="logic" class="button right" href="#">
		<span class="icon icon-report"></span>逻辑设置
	</a>
	<a id="section" class="button right" href="#" onclick="addPane()">
		<span class="icon icon-replaceexpert"></span>板块设置
	</a>
</div>
		...
		<div class="table">
			...
			<div id="add_question" align =center>
			     <ul style="list-style-type:none;">
					...
					<li style="margin-top:10px;">
						<a id="addBt8" class="button" onclick= "savePaper()">
...
<script type="text/javascript">
	...
	savePaper = function() {
		...
		// 如果没有指明题目，显然不合理
		if (jSONArr.length <= 1) {
			alert_dialog("请编辑至少 一道题目");
		} else {
			$.ajax({ 
		        type : "POST", 
		        url : "${ContextPath}/survey/qedit/savePaper/" + guid, 
		        dataType : "json",      
	...
	function preview() {
		var guid = $("#guid").val().trim();
		var getQuestionContentUrl = "${ContextPath}/survey/qedit/preview/" + guid;
		var getPaperNameAndIntroUrl = "${ContextPath}/survey/qedit/previewGetPaperNameAndTitle/" + guid;
