...
<div class="con_header">
	<h3><span class="icon icon-web"></span>学校信息维护</h3>
</div>
<!-- 以下是联系人信息列表--by刘琪 -->
<div class="infofr_div" > 
	<fieldset class = "infofr_fieldset">
		...
		<form action="" class = "infofr_form" id = "infoForm" >
			...
			<label for="name" class = "info_label2">学校名称：</label>
			...
			<input type="text" id = "memo" name = "memo" class = "info_input_memo"  value="${user.memo}"/>
			<br />
...
$("#cancelButton").click(function(){
	...
	document.getElementById("cancelButton").style.visibility = "hidden";
	intoSaveStyle();
	$.post('${ContextPath}/InfoMaintain/universityMaintain',
			function(data){
				$( "#content" ).empty();
				$( "#content" ).append( data );
			}, 
...
function saveInfo(){
	...
	if(!$(".infofr_form").valid())
		...
		$.ajax({
			type:'POST',
			url:'${ContextPath}/InfoMaintain/universityMaintainsaveEditSelf',
			data:fmstr,//密码改为从Session里边读取
