...
<div class="con_header">
	<h3>
		<span class="icon icon-web"></span>教师列表
	</h3>
</div>
...
<div class="toolbar" style="overflow:hidden">
	<table class="layout_table left">
		<tr>
			<td><a class="button" href="#" onclick="batchImportDialog('/DSEP/infoMaintain/BatchImport')"><span
				class="icon icon-import"></span>批量导入</a></td>
			<td><a class="button" href="#" onclick="batchExportDialog('/DSEP/infoMaintain/BatchExport')"><span
	...
	<div id="batch_import"></div>
	<div id="batch_export"></div>
	<script type="text/javascript">
	function batchImportDialog(url)
    {
  	  $.post(url, function(data){
  		  //alert(data);
  		  $( "#batch_import" ).append( data );
  	 	  $('#feedback_detial_dv').dialog({
  	  		    title:"批量导入文件",
  	  		    height:'400',
  	  			width:'70%',
  	  			position:'center',
	...
	function batchExportDialog(url)
    {
  	  $.post(url, function(data){
  		  //alert(data);
  		  $( "#batch_export" ).removeData();
  		  $( "#batch_export" ).append( data );
  	 	  $('#feedback_detial_dv').dialog({
  	  		    title:"批量导出文件",
  	  		    height:'380',
  	  			width:'50%',
