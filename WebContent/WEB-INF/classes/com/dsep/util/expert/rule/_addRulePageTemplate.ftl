		...
		<#list list as detail>
			...
			<tr>
				...
				<td>
					...
					<input type="text" size="1" name="detail${detail.sequ}.restrict1" value="100" />~~
					<input type="text" size="1" name="detail${detail.sequ}.restrict2" value="200" />
			...
			<tr class="fr_left">
				<td colspan=2>
					<input type="hidden" name="detail${detail.sequ}.sequ" value="${detail.sequ}">
					<input type="radio" name="detail${detail.sequ}.check" />${detail.chName}<br />
					<input type="hidden" name="detail${detail.sequ}.operator" value="${detail.operator}">
					<input type="hidden" name="detail${detail.sequ}.itemName" value="${detail.itemName}">
				</td>
			</tr>
			...
			<tr>
				...
				<input type="hidden" name="detail${detail.sequ}.operator" value="${detail.operator}">
				<input type="hidden" name="detail${detail.sequ}.itemName" value="${detail.itemName}">
				<input type="text" size="2" name="detail${detail.sequ}.restrict1" value="20" />
				</td>
			</tr>
			...
			<tr>
				<td>
					<input type="hidden" name="detail${detail.sequ}.sequ" value="${detail.sequ}">
					<input type="checkbox" name="detail${detail.sequ}.check" />
					${detail.chName}
					<input type="hidden" name="detail${detail.sequ}.operator" value="${detail.operator}">
					<input type="hidden" name="detail${detail.sequ}.itemName" value="${detail.itemName}">
				</td>
			...
			<tr>
				...
				<td>
					...
					<input type="hidden" name="detail${detail.sequ}.operator" value="${detail.operator}">
					<input type="hidden" name="detail${detail.sequ}.itemName" value="${detail.itemName}">
					<input type="text" size="1" name="detail${detail.sequ}.restrict1" value="40" />~~
					<input type="text" size="1" name="detail${detail.sequ}.restrict2" value="60" />
				</td>
			</tr>
			...
			<tr>
				<td>
					<input type="hidden" name="detail${detail.sequ}.sequ" value="${detail.sequ}">
					<input type="checkbox" name="detail${detail.sequ}.check" checked="checked" />
					${detail.chName}
					<input type="hidden" name="detail${detail.sequ}.operator" value="${detail.operator}">
					<input type="hidden" name="detail${detail.sequ}.itemName" value="${detail.itemName}">
				</td>
