	<table class="textCenter">
		...
		<tbody>
			...
			<tr class="simSun wuHao">
				...
				<td width="5.59cm">${(XCBZZData.ZZMC)?html}</td>
				<td width="2.09cm">${(XCBZZData.ZZLX)?html}</td>
				<td width="3.59cm">${(XCBZZData.ISBNH)}</td>
				<td width="3.09cm">${(XCBZZData.CBS)?html}</td>
				<td width="2.09cm">${(XCBZZData.CBLX)?html}</td>
				...
				<td width="2.09cm">${(XCBZZData.BRJS)?html}</td>
			</tr>
			</#list>
			<!--freemarker end-->			
		</tbody>
