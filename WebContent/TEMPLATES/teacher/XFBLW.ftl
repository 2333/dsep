	<table class="textCenter">
		...
		<tbody>
			...
			<tr class="simSun wuHao">
				...
				<td width="5.09cm">${(XFBLWData.LWTM)?html}</td>
				<td width="3.09cm">${(XFBLWData.FBQKMC)?html}</td>
				<td width="2.09cm">${(XFBLWData.ISSN_NUMBER)?html}</td>
				<td width="2.09cm">${(XFBLWData.FBNY)?html}</td>
				<td width="2.09cm">${(XFBLWData.LWSLLX)?html}</td>
				<td width="2.29cm">${(XFBLWData.QKYXYZ)?html}</td>
				<td width="1.59cm">${(XFBLWData.LWDYZZ)?html}</td>
				<td width="2.09cm">${(XFBLWData.TXZZ)?html}</td>
				<td width="1.59cm">${(XFBLWData.BRPX)?html}</td>
				<td width="2.09cm">${(XFBLWData.ZZSMQK)?html}</td>
			</tr>
			</#list>
			<!--freemarker end-->			
		</tbody>
