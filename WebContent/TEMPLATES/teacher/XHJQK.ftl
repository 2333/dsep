	<table class="textCenter">
		...
		<tbody>
			...
			<tr class="simSun wuHao">
				...
				<td width="5.52cm">${(XHJQKData.HJXMMC)?html}</td>
				<td width="3.82cm">${(XHJQKData.HJZSBH)?html}</td>
				<td width="2.32cm">${(XHJQKData.JLLB)?html}</td>
				<td width="2.32cm">${(XHJQKData.SJDW)?html}</td>
				<td width="1.52cm">${(XHJQKData.HJDJ)?html}</td>
				<td width="1.52cm">${(XHJQKData.HJND)?html}</td>
				<td width="2.32cm">${(XHJQKData.HJDW)?html}</td>
				<td width="2.02cm">${(XHJQKData.DYHJR)?html}</td>
				<td width="1.52cm">${(XHJQKData.BRPX)?html}</td>
			</tr>
			</#list>
			<!--freemarker end-->			
		</tbody>
