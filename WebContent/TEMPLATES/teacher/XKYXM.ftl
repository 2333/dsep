	<table class="textCenter">
		...
		<tbody>
			...
			<tr class="simSun wuHao">
				...
				<td width="5.09cm">${(XKYXMData.XMMC)?html}</td>
				<td width="5.09cm">${(XKYXMData.XMBH)?html}</td>
				<td width="3.09cm">${(XKYXMData.XMLB)?html}</td>
				<td width="2.09cm">${(XKYXMData.XMXDDW)?html}</td>
				<td width="2.09cm">${(XKYXMData.XMCDDWMC)?html}</td>
				<td width="2.09cm">${(XKYXMData.XMFZRXM)?html}</td>
				<td width="1.29cm">${(XKYXMData.XMXDNY)?html}</td>
				<td width="1.29cm">${(XKYXMData.XMKSNY)?html}</td>
				<td width="1.29cm">${(XKYXMData.XMJSNY)?html}</td>
				<td width="1.49cm">${(XKYXMData.HTJF)?html}</td>
			</tr>
			</#list>
			<!--freemarker end-->			
		</tbody>
