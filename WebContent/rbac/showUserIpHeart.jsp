...
<div class="con_header">
	<h3>
		<span class="icon icon-user"></span>用户管理
	</h3>
</div>
...
<script type="text/javascript">
	$(document).ready(function(){    	
	   	...
	   	$('#userlist_tb').jqGrid({
	 		url: '${ContextPath}/rbac/userIpHeartQuery',
	        datatype: 'json',
	        mtype: 'GET',
			...
			colModel:[
					...
					{name:'user.idCardNo',index:'idCardNo', width:80,align:"center", align:"center",sorttype:"String",editable:true,hidden:true},
					{name:'userTypeName',index:'userTypeName', width:80,align:"center", align:"center",sorttype:"String",editable:true },
					{name:'user.unitId',index:'unitId', width:80,align:"center", align:"center",sorttype:"String",editable:true },
					{name:'user.discId',index:'discId', width:80,align:"center", align:"center",sorttype:"String",editable:true },
					{name:'user.schoolName',index:'schoolName', width:80,align:"center", align:"center",sorttype:"String",editable:true ,hidden:true},
					{name:'user.email',index:'email', width:80,align:"center", align:"center",sorttype:"String",editable:true ,hidden:true},
					{name:'user.officePhone',index:'officePhone', width:80,align:"center", align:"center",sorttype:"String",editable:true ,hidden:true},
					{name:'user.cellPhone',index:'cellPhone', width:80,align:"center", align:"center",sorttype:"String",editable:true ,hidden:true},
					{name:'user.officeAddr',index:'officeAddr', width:80,align:"center", align:"center",sorttype:"String",editable:true ,hidden:true},
					{name:'user.address',index:'address', width:80,align:"center", align:"center",sorttype:"String",editable:true ,hidden:true},
					{name:'user.zipCode',index:'zipCode',align:"center", width:100,sorttype:"String",editable:true ,hidden:true},
					{name:'user.memo',index:'memo',align:"center", width:100,sorttype:"String",editable:true ,hidden:true}
			],
			height:'100%',
			autowidth:true,
			pager: '#user_pager_tb',
