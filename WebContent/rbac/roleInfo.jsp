...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
 <div id="editRole_dv" class="form" >
     <form id="editRole_fm" class="fr_form" method="post">  
           <table class="fr_table">  
              ...
              <%-- <tr>
                  ...
                  <td>  
                      <input type="text" name="category" value="${role.category}"/>  
                  </td>   
              </tr>	 --%>
			  <tr>
				  <td style="vertical-align:top;"><label>菜单权限：</label></td>
					<td >
						<div class="fr_panel">
							<ul id="editmenuright" class="ztree"></ul>
			   			</div>
					</td>
					<td style="vertical-align:top;"><label>动作权限：</label></td>
					<td >
						<div class="fr_panel">
							<ul id="editactionright" class="ztree"></ul>
			   			</div>
					</td>
				  </tr>
           </table>  
...
<script type="text/javascript">
	...
	$(function(){  
       ...
       $.fn.zTree.init($("#editmenuright"), setting, zNodes_menu);
	   $.fn.zTree.init($("#editactionright"), setting, zNodes_action);
	});
