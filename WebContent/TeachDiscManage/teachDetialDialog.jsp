...
<table class="layout_table left" >
	<tr>
			<td>
				...
				<span class="TextFont">教师详细信息</span>
			</td>
		</tr>
</table>
</div>
...
<a id="back2TeachList" class="button" href="#" style="margin-top:5px;margin-left:600px;"><span class="icon icon-export "></span>返回</a >	 
	<script type="text/javascript">
		function back2TeachList(){
			var reUrl = '${ContextPath}/teachDiscManage/viewTeachList';
