...
<div id="addRuleInfo_div" class="form">
	<form id="rule">
		<table id="add_rule_tb_dialog" class="fr_table">
			<tr>
				<td width='160'><span class="TextBold">关联批次信息</span></td>
				<td><input type="text" id="batchName" disabled="disabled" size="30"/></td>
				<td><input type="hidden" id="batchId"></td>
			</tr>
			<tr>
				<td width='160'><span class="TextBold">遴选规则名称：</span></td>
				<td><input type="text" name="rule.ruleName" size="30" /></td>
			</tr>
		</table>
	</form>
	
	<form id="details">
		<table id="add_Rule_tb_dialog" class="fr_table_addRule" style="float:left">
			<tr>
				<td width='165'>
				...
				<td>
					...
					<input type="text" size="1" name="detail1.restrict1" value="100" />~~
					<input type="text" size="1" name="detail1.restrict2" value="200" />
			...
			<tr>
				...
				<td>
					...
					<input type="text" size="1" name="detail2.restrict1" value="100" />~~
					<input type="text" size="1" name="detail2.restrict2" value="200" />
		  ...
		  <table id="add_Rule_tb_dialog2" class="fr_table_addRule" style="float:right">	
			<tr>
			...
			<tr>
				...
				<input type="text" size="2" name="detail11.restrict1" value="20" />%
				</td>
			</tr>
			<tr>
				<td>
...
$(document).ready(function() {
    ...
    //alert(batchName);
    $("#batchName").val(currentBatchName);
    $("#batchId").val(currentBatchId);
});
</script>