	...
	<form id="rule">
		<table id="add_rule_tb_dialog" class="fr_table">
			<tr>
				...
				<td><input type="text" name="rule.ruleName"  size="60"/></td>
			</tr>
		</table>
	</form>
		...
		<table id="add_Rule_tb_dialog" class="fr_table">
			...
			<tr>
				...
				<td>
					...
					<input type="text" size="1" name="detail1.restrict1" value="100" onblur="checkSameDisciplineSumLimit(this);"/>~~
					<input type="text" size="1" name="detail1.restrict2" value="200" onblur="checkSameDisciplineSumLimit(this);"/>
			...
			<tr>
				...
				<td>
					...
					<input type="text" size="1" name="detail2.restrict1" value="10" onblur="checkSameUnitSumLimit(this);"/>~~
					<input type="text" size="1" name="detail2.restrict2" value="20" onblur="checkSameUnitSumLimit(this);"/>
			...
			<tr>
				...
				<input type="text" size="2" name="detail3.restrict1" value="20" onblur="checkDisciplineNumber(this)"/>
				<input type="hidden" name="detail4.sequ" value="4">
				<input type="checkbox" name="detail4.check" />
				不设置
			...
			<tr class="fr_left">
				<td colspan=2>
					...
					<input type="radio" name="detail5.check" checked="checked"/>仅在参评单位中选<br />
			...
			<tr>
				...
				<td>
					...
					<input type="text" size="1" name="detail9.restrict1" value="40" onblur="checkAgeLimit(this);"/>~~
					<input type="text" size="1" name="detail9.restrict2" value="60" onblur="checkAgeLimit(this);"/>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<input type="text" size="1" name="detail11.restrict1" value="20" onblur="checkManageExpertPCT(this);"/>%
					<input type="hidden" name="detail10.sequ" value="10">
					<input type="checkbox" name="detail10.check" />
					不设置
