...
<script type="text/javascript">
    	...
    	$("#project_name").val($("#itemName").val());
   		...
   		$("#file_upload").uploadify({  
   	 	...
   	 	$('#return_btn').click(function(){
   	 		$.post("${ContextPath}/project/papply", function(data){
				$( "#content" ).empty();
			  	$( "#content" ).append( data );
		 	}, 'html');
   		});
    ...
    $("#guide_list").jqGrid({
    	...
    	$("#guide_list").jqGrid('setGridWidth', '985');
