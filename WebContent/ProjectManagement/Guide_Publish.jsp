...
<div class="con_header">
	<h3>
		<span class="icon icon-user"></span>新建项目
	</h3>
</div>
	...
	<form id="fm_addGuides" class="fr_form" method="post">  
		<table class="layout_table left">
			...
			<tr>
				...
				<td colspan="4">
					<input id="guide_name" name="guide_name" type="text" size="50"/>
				</td>
			</tr>
			</table>
...
<div class="selectbar inner_table_holder">
	<table class="layout_table left">
		<tr>
			<td>
				<a  id="publish_btn" class="button" href="#"><span class="icon icon-store"></span>保存</a>
			</td>
			<td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
    	 	...
    	 	$('#publish_btn').click(function(){
    	 		//console.log($("#fm_addGuides").serialize()+"&attachmentId="+$("#file_no").text());
    			if(checkNotNull())
    			{
    	 		$.post("${ContextPath}/project/punit_saveAdd", $("#fm_addGuides").serialize()+"&attachmentId="+$("#file_no").text() , function(data){
    				if(data){
    					alert_dialog("保存成功！");
    					$('#return_btn').click();
    				}
