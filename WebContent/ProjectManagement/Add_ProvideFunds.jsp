...
<div class="inner_table_holder">
	<form id="fm_addFundsProvide" class="fr_form" method="post">  
		<table class="layout_table left"> 
			<tr>
				<td>
					<span class="TextFont">经费金额：</span>
				</td>
				<td width="200px">
					<input id="provideAmount" name="provideAmount" type="text" value=""  size='5'/>（万元）
				</td>
 			    <td>
					<span class="TextFont">下批时间：</span>
				</td>
				<td>
					<input id="provide_Time" name="provide_Time" type="text"/>
				</td> 
				<td class="hidden">
...
<script type="text/javascript">
	...
	$.datepicker.regional['zh-CN'] = {  
	   ...
	   jQuery("#provide_Time").datepicker({
		   yearRange:'1900:2020',
		   changeMonth: true,
           changeYear: true,
	 ...
	 jQuery("#provide_Time").click(function(){
